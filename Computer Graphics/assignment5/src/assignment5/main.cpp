...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Bezier Assignment", nullptr, nullptr);
    ...
    int width, height;
    unsigned char* image = SOIL_load_image("teletubbies.jpg", &width, &height, 0, SOIL_LOAD_RGB);
